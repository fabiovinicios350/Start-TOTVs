...
Function Main()
    ...
    if (nvalorAleatorio = nValorUsuario)
        Resultado("Numero informado e igual que o numero sortiado","")
    ...
    Resultado("O valor maior e ",Alltrim(str(nValorUsuario)))
    Resultado("O valor menor e ",Alltrim(str(nvalorAleatorio)))
