...
#define TITULO "CALCULAR MONTANTE"
...
Function Main()
    ...
    ACCEPT "Digite o seu Capital inicial: " TO nCapital
    nCapital := Val(ValidarCaracter(nCapital,"numerico"))
    ...
    CalcularMontante(nCapital,nTaxa,nTempo,cTipoRegime)

    ResultadoCabecalho()
    Resultado("O valor do juros e: ",Alltrim(str(nValorJuros)))
    Resultado("A Montante e: ",Alltrim(str(nValorFuturo)))
    ResultadoFechar()
