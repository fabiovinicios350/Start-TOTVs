...
Function Main()
   ...
   //Declarando Variaveis
    ...
    Resultado("Resposta Exercicio 30","")
    Resultado("","")
    Resultado("A finalidade do programa e inverter a palavra","")
    Resultado("Coloar de tras pra frete","")
    Resultado("","")
    Resultado("Exemplo: AMOR","")
